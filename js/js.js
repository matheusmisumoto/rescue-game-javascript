...
function start() {
    ...
    function placar() {
        $("#placar").html("<h2> Score: " + pontos + " Saved: " + salvos + " Lost: " + perdidos + "</h2>");
    }
    ...
    function gameOver() {
        ...
        $("#fim").html("<h1> Game Over </h1><p>Your Score: " + pontos + "</p>" + "<div id='reinicia' onClick=reiniciaJogo()><h3>Try again</h3></div>");
    }
